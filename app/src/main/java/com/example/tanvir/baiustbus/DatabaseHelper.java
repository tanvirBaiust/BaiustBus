...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static final String Database_Name="Bus3.db";
    public static final String Table_Name3="Bus_Table3";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table "+Table_Name3+" (Time TEXT PRIMARY KEY, FROME TEXT, VIA TEXT , TOO TEXT)");
    }
    ...
    public Integer deleteData(String Time){
        SQLiteDatabase db=this.getWritableDatabase();
        return db.delete(Table_Name3,"Time=?",new String[] {Time});
    }
}
