...
public class InterCampusDatabase2Activity extends AppCompatActivity {
    ListView listview;
    SQLiteDatabase sqLiteDatabase;
    Cursor cursor;
    InterCampusDatabaseHelper databaseHelper;
    ListAdapter listAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_inter_campus_database2);
        listview = (ListView) findViewById(R.id.list_view);
        databaseHelper = new InterCampusDatabaseHelper(getApplicationContext());
